    ...
    return (
        <div className='mt-14'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-9'>
                {data.map(d => <div data-aos='fade-up' key={d._id} className={`card card-side cb w-full  ${tf? 'bg-stone-300 text-black': 'bg-gray-800 text-white'}  border border-slate-800 `}>
